...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'revisar',     label: 'Revisar',     icon: <RefreshCw size={20} />       },
  { id: 'praticar',    label: 'Praticar',    icon: <HelpCircle size={20} />      },
  { id: 'redacao',     label: 'Redação',     icon: <PenLine size={20} />         },
  { id: 'cronograma',  label: 'Cronograma',  icon: <CalendarClock size={20} />   },
  { id: 'anotacoes',   label: 'Anotações',   icon: <NotebookPen size={20} />     },
];
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: isActive ? NAV_PRIMARY : 'rgba(255,255,255,0.4)',
                  fontFamily: 'Lexend, sans-serif',
                  fontSize: '13px', fontWeight: isActive ? 700 : 500,
                  letterSpacing: '0.01em',
                  transition: 'all 0.2s ease',
                  position: 'relative',
                  boxShadow: isActive ? `inset 3px 0 0 ${NAV_PRIMARY}` : 'none',
                }}
                onMouseEnter={e => {
                  if (!isActive) {
